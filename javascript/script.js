...
const renderOperation = (operation) => {
    ...
    listItem.innerHTML = `${operation.description}
        <span class="history__money">${operation.amount} сом</span>
...
const updateBalance = () =>{
    ...
    totalMoneyIncome.textContent = resultIncome + ' сом ';
    totalMoneyExpenses.textContent = resultExpenses + ' сом ';
    totalBalance.textContent = (resultIncome + resultExpenses) + ' сом ';
